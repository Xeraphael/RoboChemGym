...
class DeviceOperateTask(BaseTask):
    ...
    def __init__(self, cfg, world, stage, robot):
        ...
        # 将YAML配置中的ListConfig转换为numpy array
        self.interior_position = np.array(cfg.task.device_interior_position)
        self.beaker3_target_position = np.array(cfg.task.beaker3_target_position)
